...
class Producto(models.Model):
    ...
    images = models.ImageField(upload_to='fotos/productos', verbose_name="Imagen del producto" )
...
class ReseñaRating(models.Model):
    ...
    reseña = models.CharField(max_length=500, blank=True , verbose_name="Reseña")
    rating = models.FloatField(verbose_name="Calificación Reseña")  # Calificación del producto (1-5)
...
class ProductoGaleria(models.Model):
    producto = models.ForeignKey(Producto, default=None, on_delete=models.CASCADE, verbose_name="Producto")
    image = models.ImageField(upload_to='tienda/productos', max_length=255, verbose_name="Imagen")
  ...
  # Este método devuelve el nombre del producto al que pertenece la imagen
    def __str__(self):
